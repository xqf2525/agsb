...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "xqf2525"         # 用户名
UUID = "2e3bd455-e3eb-4b81-a639-0f4412708564"                     # UUID，留空则自动生成
PORT = 59999                   # Vmess端口，留空或0则自动生成
DOMAIN = "pn.kni2525.top"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiZDdhNzUwM2Q3MWNjMDNlOTI0NTg1ZTI5NjJmZGM5ODgiLCJ0IjoiNmQwYjQ0ZmYtOWQ0NS00Yzg2LTk0NDMtY2E4MTJiM2I4OTcwIiwicyI6Ik1EazJOR1EzTmpZdFptSmhNaTAwTVdFd0xXSmhNVEF0WlRCbVlUZzVZVEl4TWpsbSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
